...
/**
 * ChannelStateRollerShutter Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelStateRollerShutter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelStateRollerShutter';
    ...
    public function setShut($shut)
    {
        ...
        if (!is_null($shut) && ($shut > 100)) {
            throw new \InvalidArgumentException('invalid value for $shut when calling ChannelStateRollerShutter., must be smaller than or equal to 100.');
        }
        if (!is_null($shut) && ($shut < 0)) {
            throw new \InvalidArgumentException('invalid value for $shut when calling ChannelStateRollerShutter., must be bigger than or equal to 0.');
        }
