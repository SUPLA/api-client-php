...
class ClientAppsApi
{
     ...
     * @return \Supla\ApiClient\Model\ClientApp
     */
    public function updateClientApp($id, $inlineObject6)
    {
        list($response) = $this->updateClientAppWithHttpInfo($id, $inlineObject6);
        return $response;
    }
     ...
     * @return array of \Supla\ApiClient\Model\ClientApp, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateClientAppWithHttpInfo($id, $inlineObject6)
    {
        $request = $this->updateClientAppRequest($id, $inlineObject6);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateClientAppAsync($id, $inlineObject6)
    {
        return $this->updateClientAppAsyncWithHttpInfo($id, $inlineObject6)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateClientAppAsyncWithHttpInfo($id, $inlineObject6)
    {
        $returnType = '\Supla\ApiClient\Model\ClientApp';
        $request = $this->updateClientAppRequest($id, $inlineObject6);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateClientAppRequest($id, $inlineObject6)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inlineObject6 === null || (is_array($inlineObject6) && count($inlineObject6) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject6 when calling updateClientApp'
            );
        }
