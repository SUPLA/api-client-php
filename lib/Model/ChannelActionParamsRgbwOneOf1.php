...
/**
 * ChannelActionParamsRgbwOneOf1 Class Doc Comment
 *
 * @category Class
 * @package  Supla\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ChannelActionParamsRgbwOneOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelActionParamsRgbw_oneOf_1';
    ...
    public function setHue($hue)
    {
        ...
        if (!is_null($hue) && ($hue > 359)) {
            throw new \InvalidArgumentException('invalid value for $hue when calling ChannelActionParamsRgbwOneOf1., must be smaller than or equal to 359.');
        }
        if (!is_null($hue) && ($hue < 0)) {
            throw new \InvalidArgumentException('invalid value for $hue when calling ChannelActionParamsRgbwOneOf1., must be bigger than or equal to 0.');
        }
    ...
    public function setColorBrightness($colorBrightness)
    {
        ...
        if (!is_null($colorBrightness) && ($colorBrightness > 100)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ChannelActionParamsRgbwOneOf1., must be smaller than or equal to 100.');
        }
        if (!is_null($colorBrightness) && ($colorBrightness < 0)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ChannelActionParamsRgbwOneOf1., must be bigger than or equal to 0.');
        }
