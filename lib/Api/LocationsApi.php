...
class LocationsApi
{
     ...
     * @return \Supla\ApiClient\Model\Location
     */
    public function updateLocation($id, $inlineObject8)
    {
        list($response) = $this->updateLocationWithHttpInfo($id, $inlineObject8);
        return $response;
    }
     ...
     * @return array of \Supla\ApiClient\Model\Location, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateLocationWithHttpInfo($id, $inlineObject8)
    {
        $request = $this->updateLocationRequest($id, $inlineObject8);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLocationAsync($id, $inlineObject8)
    {
        return $this->updateLocationAsyncWithHttpInfo($id, $inlineObject8)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLocationAsyncWithHttpInfo($id, $inlineObject8)
    {
        $returnType = '\Supla\ApiClient\Model\Location';
        $request = $this->updateLocationRequest($id, $inlineObject8);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateLocationRequest($id, $inlineObject8)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inlineObject8 === null || (is_array($inlineObject8) && count($inlineObject8) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject8 when calling updateLocation'
            );
        }
