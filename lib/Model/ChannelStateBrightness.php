...
/**
 * ChannelStateBrightness Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelStateBrightness implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelStateBrightness';
    ...
    public function setBrightness($brightness)
    {
        ...
        if (!is_null($brightness) && ($brightness > 100)) {
            throw new \InvalidArgumentException('invalid value for $brightness when calling ChannelStateBrightness., must be smaller than or equal to 100.');
        }
        if (!is_null($brightness) && ($brightness < 0)) {
            throw new \InvalidArgumentException('invalid value for $brightness when calling ChannelStateBrightness., must be bigger than or equal to 0.');
        }
