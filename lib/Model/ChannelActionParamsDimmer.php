...
/**
 * ChannelActionParamsDimmer Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelActionParamsDimmer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelActionParamsDimmer';
    ...
    public function setBrightness($brightness)
    {
        ...
        if (!is_null($brightness) && ($brightness > 100)) {
            throw new \InvalidArgumentException('invalid value for $brightness when calling ChannelActionParamsDimmer., must be smaller than or equal to 100.');
        }
        if (!is_null($brightness) && ($brightness < 0)) {
            throw new \InvalidArgumentException('invalid value for $brightness when calling ChannelActionParamsDimmer., must be bigger than or equal to 0.');
        }
