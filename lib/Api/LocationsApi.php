...
class LocationsApi
{
     ...
     * @return \Supla\ApiClient\Model\Location
     */
    public function updateLocation($id, $inlineObject3)
    {
        list($response) = $this->updateLocationWithHttpInfo($id, $inlineObject3);
        return $response;
    }
     ...
     * @return array of \Supla\ApiClient\Model\Location, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateLocationWithHttpInfo($id, $inlineObject3)
    {
        $request = $this->updateLocationRequest($id, $inlineObject3);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLocationAsync($id, $inlineObject3)
    {
        return $this->updateLocationAsyncWithHttpInfo($id, $inlineObject3)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLocationAsyncWithHttpInfo($id, $inlineObject3)
    {
        $returnType = '\Supla\ApiClient\Model\Location';
        $request = $this->updateLocationRequest($id, $inlineObject3);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateLocationRequest($id, $inlineObject3)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inlineObject3 === null || (is_array($inlineObject3) && count($inlineObject3) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject3 when calling updateLocation'
            );
        }
