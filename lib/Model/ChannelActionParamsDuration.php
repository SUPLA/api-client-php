...
/**
 * ChannelActionParamsDuration Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelActionParamsDuration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelActionParamsDuration';
    ...
    */
    ...
    public function setDurationMs($durationMs)
    {
        ...
        if (($durationMs > 31536000000)) {
            throw new \InvalidArgumentException('invalid value for $durationMs when calling ChannelActionParamsDuration., must be smaller than or equal to 31536000000.');
        }
        if (($durationMs < 0)) {
            throw new \InvalidArgumentException('invalid value for $durationMs when calling ChannelActionParamsDuration., must be bigger than or equal to 0.');
        }
