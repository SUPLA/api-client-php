...
/**
 * ChannelStateColor Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelStateColor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelStateColor';
    ...
    */
    ...
    public function setColorBrightness($colorBrightness)
    {
        ...
        if (($colorBrightness > 100)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ChannelStateColor., must be smaller than or equal to 100.');
        }
        if (($colorBrightness < 0)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ChannelStateColor., must be bigger than or equal to 0.');
        }
