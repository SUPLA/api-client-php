...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://YOUR_SUPLA_SERVER/api/v2.4.0';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/3.0.0-beta.1/PHP';
    ...
    public function setAccessToken($accessToken)
    {
        ...
        $this->setHost($suplaUrl . '/api/v2.4.0');
    ...
    {
        $report  = 'PHP SDK (Supla\ApiClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.3.37' . PHP_EOL;
        $report .= '    SDK Package Version: 3.0.0-beta.1' . PHP_EOL;
