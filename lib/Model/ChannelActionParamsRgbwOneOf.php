...
/**
 * ChannelActionParamsRgbwOneOf Class Doc Comment
 *
 * @category Class
 * @package  Supla\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ChannelActionParamsRgbwOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelActionParamsRgbw_oneOf';
    ...
    */
    ...
    public function setColorBrightness($colorBrightness)
    {
        ...
        if (($colorBrightness > 100)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ChannelActionParamsRgbwOneOf., must be smaller than or equal to 100.');
        }
        if (($colorBrightness < 0)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ChannelActionParamsRgbwOneOf., must be bigger than or equal to 0.');
        }
