...
class ChannelsApi
{
     ...
     */
    public function createChannelReaction($channel, $inlineObject10, $include = null)
    {
        list($response) = $this->createChannelReactionWithHttpInfo($channel, $inlineObject10, $include);
        return $response;
    }
     ...
     */
    public function createChannelReactionWithHttpInfo($channel, $inlineObject10, $include = null)
    {
        $request = $this->createChannelReactionRequest($channel, $inlineObject10, $include);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createChannelReactionAsync($channel, $inlineObject10, $include = null)
    {
        return $this->createChannelReactionAsyncWithHttpInfo($channel, $inlineObject10, $include)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createChannelReactionAsyncWithHttpInfo($channel, $inlineObject10, $include = null)
    {
        $returnType = '\Supla\ApiClient\Model\Reaction';
        $request = $this->createChannelReactionRequest($channel, $inlineObject10, $include);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createChannelReactionRequest($channel, $inlineObject10, $include = null)
    {
        ...
        if ($inlineObject10 === null || (is_array($inlineObject10) && count($inlineObject10) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject10 when calling createChannelReaction'
            );
        }
     ...
     *
     * @param  int $id ID (required)
     * @param  bool $safe Whether to perform actions that require data loss (e.g. delete schedules when deleting the channel) (optional)
     *
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteChannel($id, $safe = null)
    {
        $this->deleteChannelWithHttpInfo($id, $safe);
    }
     ...
     */
    public function deleteChannelWithHttpInfo($id, $safe = null)
    {
        $request = $this->deleteChannelRequest($id, $safe);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteChannelAsync($id, $safe = null)
    {
        return $this->deleteChannelAsyncWithHttpInfo($id, $safe)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteChannelAsyncWithHttpInfo($id, $safe = null)
    {
        $returnType = '';
        $request = $this->deleteChannelRequest($id, $safe);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteChannelRequest($id, $safe = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return object
     */
    public function executeSubDeviceAction($channelId, $inlineObject3)
    {
        list($response) = $this->executeSubDeviceActionWithHttpInfo($channelId, $inlineObject3);
        return $response;
    }
     ...
     */
    public function executeSubDeviceActionWithHttpInfo($channelId, $inlineObject3)
    {
        $request = $this->executeSubDeviceActionRequest($channelId, $inlineObject3);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function executeSubDeviceActionAsync($channelId, $inlineObject3)
    {
        return $this->executeSubDeviceActionAsyncWithHttpInfo($channelId, $inlineObject3)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function executeSubDeviceActionAsyncWithHttpInfo($channelId, $inlineObject3)
    {
        $returnType = 'object';
        $request = $this->executeSubDeviceActionRequest($channelId, $inlineObject3);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function executeSubDeviceActionRequest($channelId, $inlineObject3)
    {
        ...
        if ($inlineObject3 === null || (is_array($inlineObject3) && count($inlineObject3) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject3 when calling executeSubDeviceAction'
            );
        }
    ...
    {
        list($response) = $this->getChannelsStatesWithHttpInfo();
        return $response;
    }
     ...
     * @return array of object[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelsStatesWithHttpInfo()
    {
        $request = $this->getChannelsStatesRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelsStatesAsync()
    {
        return $this->getChannelsStatesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelsStatesAsyncWithHttpInfo()
    {
        $returnType = 'object[]';
        $request = $this->getChannelsStatesRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelsStatesRequest()
    {
     ...
     * @return \Supla\ApiClient\Model\Reaction[]
     */
    public function getReactions($include = null)
    {
        list($response) = $this->getReactionsWithHttpInfo($include);
        return $response;
    }
     ...
     * @return array of \Supla\ApiClient\Model\Reaction[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getReactionsWithHttpInfo($include = null)
    {
        $request = $this->getReactionsRequest($include);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReactionsAsync($include = null)
    {
        return $this->getReactionsAsyncWithHttpInfo($include)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReactionsAsyncWithHttpInfo($include = null)
    {
        $returnType = '\Supla\ApiClient\Model\Reaction[]';
        $request = $this->getReactionsRequest($include);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getReactionsRequest($include = null)
    {
     ...
     * @return \Supla\ApiClient\Model\Reaction
     */
    public function updateChannelReaction($channel, $reaction, $inlineObject11, $include = null)
    {
        list($response) = $this->updateChannelReactionWithHttpInfo($channel, $reaction, $inlineObject11, $include);
        return $response;
    }
     ...
     * @return array of \Supla\ApiClient\Model\Reaction, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateChannelReactionWithHttpInfo($channel, $reaction, $inlineObject11, $include = null)
    {
        $request = $this->updateChannelReactionRequest($channel, $reaction, $inlineObject11, $include);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateChannelReactionAsync($channel, $reaction, $inlineObject11, $include = null)
    {
        return $this->updateChannelReactionAsyncWithHttpInfo($channel, $reaction, $inlineObject11, $include)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateChannelReactionAsyncWithHttpInfo($channel, $reaction, $inlineObject11, $include = null)
    {
        $returnType = '\Supla\ApiClient\Model\Reaction';
        $request = $this->updateChannelReactionRequest($channel, $reaction, $inlineObject11, $include);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateChannelReactionRequest($channel, $reaction, $inlineObject11, $include = null)
    {
        // verify the required parameter 'channel' is set
        if ($channel === null || (is_array($channel) && count($channel) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inlineObject11 === null || (is_array($inlineObject11) && count($inlineObject11) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject11 when calling updateChannelReaction'
            );
        }
