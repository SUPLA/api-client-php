...
class ChannelConfigGoogleHomeSettingsGoogleHome implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('googleHomeDisabled', $data ?? [], null);
        $this->setIfExists('needsUserConfirmation', $data ?? [], null);
        $this->setIfExists('pin', $data ?? [], null);
        $this->setIfExists('pinSet', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($googleHomeDisabled)) {
            throw new \InvalidArgumentException('non-nullable googleHomeDisabled cannot be null');
        }
    ...
    {
        if (is_null($needsUserConfirmation)) {
            throw new \InvalidArgumentException('non-nullable needsUserConfirmation cannot be null');
        }
    ...
    {
        if (is_null($pinSet)) {
            throw new \InvalidArgumentException('non-nullable pinSet cannot be null');
        }
