...
/**
 * ChannelStateDistance Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelStateDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelStateDistance';
    ...
    public function setDistance($distance)
    {
        ...
        if (!is_null($distance) && ($distance < 0)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling ChannelStateDistance., must be bigger than or equal to 0.');
        }
