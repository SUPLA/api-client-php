...
class ChannelRelationsCount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('channelGroups', $data ?? [], null);
        ...
        $this->setIfExists('actionTriggers', $data ?? [], null);
    }
    ...
    */
    ...
    public function setChannelGroups($channelGroups)
    {
        if (is_null($channelGroups)) {
            throw new \InvalidArgumentException('non-nullable channelGroups cannot be null');
        }
    ...
    {
        if (is_null($actionTriggers)) {
            throw new \InvalidArgumentException('non-nullable actionTriggers cannot be null');
        }
