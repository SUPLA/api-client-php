...
class ChannelConfigThermometer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTemperatureAdjustment($temperatureAdjustment)
    {
        ...
        if (!is_null($temperatureAdjustment) && ($temperatureAdjustment > 1000)) {
            throw new \InvalidArgumentException('invalid value for $temperatureAdjustment when calling ChannelConfigThermometer., must be smaller than or equal to 1000.');
        }
        if (!is_null($temperatureAdjustment) && ($temperatureAdjustment < -1000)) {
            throw new \InvalidArgumentException('invalid value for $temperatureAdjustment when calling ChannelConfigThermometer., must be bigger than or equal to -1000.');
        }
