...
class ChannelsApi
{
     ...
     * @return void
     */
    public function deleteChannelMeasurementLogs($channel)
    {
        $this->deleteChannelMeasurementLogsWithHttpInfo($channel);
    }
     ...
     */
    public function deleteChannelMeasurementLogsWithHttpInfo($channel)
    {
        $request = $this->deleteChannelMeasurementLogsRequest($channel);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteChannelMeasurementLogsAsync($channel)
    {
        return $this->deleteChannelMeasurementLogsAsyncWithHttpInfo($channel)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteChannelMeasurementLogsAsyncWithHttpInfo($channel)
    {
        $returnType = '';
        $request = $this->deleteChannelMeasurementLogsRequest($channel);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteChannelMeasurementLogsRequest($channel)
    {
     ...
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return OneOfArrayArrayArrayArrayArrayArray|\Supla\ApiClient\Model\ErrorResponse
     */
    public function getChannelMeasurementLogs($channel, $afterTimestamp = null, $beforeTimestamp = null, $order = 'DESC', $sparse = null, $limit = 5000, $offset = 0)
    {
        list($response) = $this->getChannelMeasurementLogsWithHttpInfo($channel, $afterTimestamp, $beforeTimestamp, $order, $sparse, $limit, $offset);
        return $response;
    }
     ...
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of OneOfArrayArrayArrayArrayArrayArray|\Supla\ApiClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelMeasurementLogsWithHttpInfo($channel, $afterTimestamp = null, $beforeTimestamp = null, $order = 'DESC', $sparse = null, $limit = 5000, $offset = 0)
    {
        $request = $this->getChannelMeasurementLogsRequest($channel, $afterTimestamp, $beforeTimestamp, $order, $sparse, $limit, $offset);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('OneOfArrayArrayArrayArrayArrayArray' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'OneOfArrayArrayArrayArrayArrayArray', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = 'OneOfArrayArrayArrayArrayArrayArray';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        'OneOfArrayArrayArrayArrayArrayArray',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelMeasurementLogsAsync($channel, $afterTimestamp = null, $beforeTimestamp = null, $order = 'DESC', $sparse = null, $limit = 5000, $offset = 0)
    {
        return $this->getChannelMeasurementLogsAsyncWithHttpInfo($channel, $afterTimestamp, $beforeTimestamp, $order, $sparse, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelMeasurementLogsAsyncWithHttpInfo($channel, $afterTimestamp = null, $beforeTimestamp = null, $order = 'DESC', $sparse = null, $limit = 5000, $offset = 0)
    {
        $returnType = 'OneOfArrayArrayArrayArrayArrayArray';
        $request = $this->getChannelMeasurementLogsRequest($channel, $afterTimestamp, $beforeTimestamp, $order, $sparse, $limit, $offset);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelMeasurementLogsRequest($channel, $afterTimestamp = null, $beforeTimestamp = null, $order = 'DESC', $sparse = null, $limit = 5000, $offset = 0)
    {
        // verify the required parameter 'channel' is set
        if ($channel === null || (is_array($channel) && count($channel) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function getChannelMeasurementLogsCsvFile($channel)
    {
        $this->getChannelMeasurementLogsCsvFileWithHttpInfo($channel);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelMeasurementLogsCsvFileWithHttpInfo($channel)
    {
        $request = $this->getChannelMeasurementLogsCsvFileRequest($channel);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelMeasurementLogsCsvFileAsync($channel)
    {
        return $this->getChannelMeasurementLogsCsvFileAsyncWithHttpInfo($channel)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelMeasurementLogsCsvFileAsyncWithHttpInfo($channel)
    {
        $returnType = '';
        $request = $this->getChannelMeasurementLogsCsvFileRequest($channel);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelMeasurementLogsCsvFileRequest($channel)
    {
        // verify the required parameter 'channel' is set
        if ($channel === null || (is_array($channel) && count($channel) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel when calling getChannelMeasurementLogsCsvFile'
            );
        }

        $resourcePath = '/channels/{channel}/measurement-logs-csv';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
