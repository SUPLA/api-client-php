...
class UpdateClientAppRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateClientApp_request';
    ...
    */
    ...
    public function setAccessIdId($accessIdId)
    {
        if (is_null($accessIdId)) {
            array_push($this->openAPINullablesSetToNull, 'accessIdId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('accessIdId', $nullablesSetToNull);
            if ($index !== FALSE) {
