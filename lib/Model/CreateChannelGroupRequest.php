...
/**
 * CreateChannelGroupRequest Class Doc Comment
 *
 * @category Class
 * @package  Supla\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateChannelGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createChannelGroup_request';
    ...
    {
        $this->setIfExists('channelsIds', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($channelsIds)) {
            throw new \InvalidArgumentException('non-nullable channelsIds cannot be null');
        }
    ...
    public function setUserIconId($userIconId)
    {
        if (is_null($userIconId)) {
            array_push($this->openAPINullablesSetToNull, 'userIconId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('userIconId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($altIcon)) {
            array_push($this->openAPINullablesSetToNull, 'altIcon');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('altIcon', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
