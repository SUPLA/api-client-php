...
class ChannelConfigHumidityAndThermometer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTemperatureAdjustment($temperatureAdjustment)
    {
        ...
        if (!is_null($temperatureAdjustment) && ($temperatureAdjustment > 10)) {
            throw new \InvalidArgumentException('invalid value for $temperatureAdjustment when calling ChannelConfigHumidityAndThermometer., must be smaller than or equal to 10.');
        }
        if (!is_null($temperatureAdjustment) && ($temperatureAdjustment < -10)) {
            throw new \InvalidArgumentException('invalid value for $temperatureAdjustment when calling ChannelConfigHumidityAndThermometer., must be bigger than or equal to -10.');
        }
    ...
    public function setHumidityAdjustment($humidityAdjustment)
    {
        ...
        if (!is_null($humidityAdjustment) && ($humidityAdjustment > 10)) {
            throw new \InvalidArgumentException('invalid value for $humidityAdjustment when calling ChannelConfigHumidityAndThermometer., must be smaller than or equal to 10.');
        }
        if (!is_null($humidityAdjustment) && ($humidityAdjustment < -10)) {
            throw new \InvalidArgumentException('invalid value for $humidityAdjustment when calling ChannelConfigHumidityAndThermometer., must be bigger than or equal to -10.');
        }
