...
class ExecuteActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'executeAction_request';
    ...
    */
    ...
    public function setPercentage($percentage)
    {
        ...
        if (($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling ExecuteActionRequest., must be smaller than or equal to 100.');
        }
        if (($percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling ExecuteActionRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setBrightness($brightness)
    {
        ...
        if (($brightness > 100)) {
            throw new \InvalidArgumentException('invalid value for $brightness when calling ExecuteActionRequest., must be smaller than or equal to 100.');
        }
        if (($brightness < 0)) {
            throw new \InvalidArgumentException('invalid value for $brightness when calling ExecuteActionRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setColorBrightness($colorBrightness)
    {
        ...
        if (($colorBrightness > 100)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ExecuteActionRequest., must be smaller than or equal to 100.');
        }
        if (($colorBrightness < 0)) {
            throw new \InvalidArgumentException('invalid value for $colorBrightness when calling ExecuteActionRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setHue($hue)
    {
        ...
        if (($hue > 359)) {
            throw new \InvalidArgumentException('invalid value for $hue when calling ExecuteActionRequest., must be smaller than or equal to 359.');
        }
        if (($hue < 0)) {
            throw new \InvalidArgumentException('invalid value for $hue when calling ExecuteActionRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDurationMs($durationMs)
    {
        ...
        if (($durationMs > 31536000000)) {
            throw new \InvalidArgumentException('invalid value for $durationMs when calling ExecuteActionRequest., must be smaller than or equal to 31536000000.');
        }
        if (($durationMs < 0)) {
            throw new \InvalidArgumentException('invalid value for $durationMs when calling ExecuteActionRequest., must be bigger than or equal to 0.');
        }
