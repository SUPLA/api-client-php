...
/**
 * ChannelActionParamsPercentage Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelActionParamsPercentage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelActionParamsPercentage';
    ...
    public function setPercentage($percentage)
    {
        ...
        if (!is_null($percentage) && ($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling ChannelActionParamsPercentage., must be smaller than or equal to 100.');
        }
        if (!is_null($percentage) && ($percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling ChannelActionParamsPercentage., must be bigger than or equal to 0.');
        }
