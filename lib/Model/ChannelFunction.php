...
class ChannelFunction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'name' => false,
        'caption' => false,
        'maxAlternativeIconIndex' => false,
        'possibleVisualStates' => false,
        'output' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('maxAlternativeIconIndex', $data ?? [], null);
        $this->setIfExists('possibleVisualStates', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($maxAlternativeIconIndex)) {
            throw new \InvalidArgumentException('non-nullable maxAlternativeIconIndex cannot be null');
        }
    ...
    {
        if (is_null($possibleVisualStates)) {
            throw new \InvalidArgumentException('non-nullable possibleVisualStates cannot be null');
        }
