...
class UpdateChannelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateChannel_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('configBefore', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($configBefore)) {
            throw new \InvalidArgumentException('non-nullable configBefore cannot be null');
        }
