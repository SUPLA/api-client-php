...
/**
 * CreateSceneRequestOperationsInner Class Doc Comment
 *
 * @category Class
 * @package  Supla\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateSceneRequestOperationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createScene_request_operations_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('delayMs', $data ?? [], null);
        $this->setIfExists('waitForCompletion', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($delayMs)) {
            throw new \InvalidArgumentException('non-nullable delayMs cannot be null');
        }
    ...
    {
        if (is_null($waitForCompletion)) {
            throw new \InvalidArgumentException('non-nullable waitForCompletion cannot be null');
        }
