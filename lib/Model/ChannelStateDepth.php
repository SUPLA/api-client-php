...
/**
 * ChannelStateDepth Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelStateDepth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelStateDepth';
    ...
    */
    ...
    public function setDepth($depth)
    {
        ...
        if (($depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling ChannelStateDepth., must be bigger than or equal to 0.');
        }
