...
/**
 * ChannelStateHumidity Class Doc Comment
 *
 * @category Class
 ...
 */
class ChannelStateHumidity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelStateHumidity';
    ...
    public function setHumidity($humidity)
    {
        ...
        if (!is_null($humidity) && ($humidity > 100)) {
            throw new \InvalidArgumentException('invalid value for $humidity when calling ChannelStateHumidity., must be smaller than or equal to 100.');
        }
        if (!is_null($humidity) && ($humidity < 0)) {
            throw new \InvalidArgumentException('invalid value for $humidity when calling ChannelStateHumidity., must be bigger than or equal to 0.');
        }
