...
class ChannelGroupsApi
{
     ...
     */
    public function createChannelGroup($inlineObject4)
    {
        list($response) = $this->createChannelGroupWithHttpInfo($inlineObject4);
        return $response;
    }
     ...
     */
    public function createChannelGroupWithHttpInfo($inlineObject4)
    {
        $request = $this->createChannelGroupRequest($inlineObject4);
     ...
     */
    public function createChannelGroupAsync($inlineObject4)
    {
        return $this->createChannelGroupAsyncWithHttpInfo($inlineObject4)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createChannelGroupAsyncWithHttpInfo($inlineObject4)
    {
        $returnType = '\Supla\ApiClient\Model\ChannelGroup';
        $request = $this->createChannelGroupRequest($inlineObject4);
     ...
     */
    public function createChannelGroupRequest($inlineObject4)
    {
        ...
        if ($inlineObject4 === null || (is_array($inlineObject4) && count($inlineObject4) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject4 when calling createChannelGroup'
            );
        }
     ...
     * @return \Supla\ApiClient\Model\ChannelGroup
     */
    public function updateChannelGroup($id, $inlineObject5)
    {
        list($response) = $this->updateChannelGroupWithHttpInfo($id, $inlineObject5);
        return $response;
    }
     ...
     * @return array of \Supla\ApiClient\Model\ChannelGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateChannelGroupWithHttpInfo($id, $inlineObject5)
    {
        $request = $this->updateChannelGroupRequest($id, $inlineObject5);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateChannelGroupAsync($id, $inlineObject5)
    {
        return $this->updateChannelGroupAsyncWithHttpInfo($id, $inlineObject5)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateChannelGroupAsyncWithHttpInfo($id, $inlineObject5)
    {
        $returnType = '\Supla\ApiClient\Model\ChannelGroup';
        $request = $this->updateChannelGroupRequest($id, $inlineObject5);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateChannelGroupRequest($id, $inlineObject5)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inlineObject5 === null || (is_array($inlineObject5) && count($inlineObject5) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject5 when calling updateChannelGroup'
            );
        }
