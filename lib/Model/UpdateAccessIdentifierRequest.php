...
/**
 * UpdateAccessIdentifierRequest Class Doc Comment
 *
 * @category Class
 * @package  Supla\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAccessIdentifierRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateAccessIdentifier_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('locationsIds', $data ?? [], null);
        $this->setIfExists('clientAppsIds', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($locationsIds)) {
            throw new \InvalidArgumentException('non-nullable locationsIds cannot be null');
        }
    ...
    {
        if (is_null($clientAppsIds)) {
            throw new \InvalidArgumentException('non-nullable clientAppsIds cannot be null');
        }
