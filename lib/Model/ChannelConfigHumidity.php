...
class ChannelConfigHumidity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setHumidityAdjustment($humidityAdjustment)
    {
        ...
        if (!is_null($humidityAdjustment) && ($humidityAdjustment > 10)) {
            throw new \InvalidArgumentException('invalid value for $humidityAdjustment when calling ChannelConfigHumidity., must be smaller than or equal to 10.');
        }
        if (!is_null($humidityAdjustment) && ($humidityAdjustment < -10)) {
            throw new \InvalidArgumentException('invalid value for $humidityAdjustment when calling ChannelConfigHumidity., must be bigger than or equal to -10.');
        }
