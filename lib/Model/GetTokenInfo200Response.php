...
/**
 * GetTokenInfo200Response Class Doc Comment
 *
 * @category Class
 * @package  Supla\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class GetTokenInfo200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTokenInfo_200_response';
    ...
    {
        $this->setIfExists('userShortUniqueId', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($userShortUniqueId)) {
            throw new \InvalidArgumentException('non-nullable userShortUniqueId cannot be null');
        }
