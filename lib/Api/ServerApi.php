...
class ServerApi
{
     ...
     * @return \Supla\ApiClient\Model\InlineResponse2001
     */
     ...
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Supla\ApiClient\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Supla\ApiClient\Model\InlineResponse2002|\Supla\ApiClient\Model\InlineResponse503
     */
     ...
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Supla\ApiClient\Model\InlineResponse2002|\Supla\ApiClient\Model\InlineResponse503, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Supla\ApiClient\Model\InlineResponse2003
     */
     ...
     * @throws \Supla\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Supla\ApiClient\Model\InlineResponse2003, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTokenInfoWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Supla\ApiClient\Model\InlineResponse2003' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Supla\ApiClient\Model\InlineResponse2003', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Supla\ApiClient\Model\InlineResponse2003';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
