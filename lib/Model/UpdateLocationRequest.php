 ...
 */
class UpdateLocationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateLocation_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('accessIdsIds', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($accessIdsIds)) {
            throw new \InvalidArgumentException('non-nullable accessIdsIds cannot be null');
        }
